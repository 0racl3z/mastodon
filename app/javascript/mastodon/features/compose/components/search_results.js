          ...
          <div className='trends'>
            ...
            {suggestions && suggestions.map(suggestion => (
              <AccountContainer
                ...
                actionIcon={suggestion.source === 'past_interaction' && 'times'}
                actionTitle={suggestion.source === 'past_interaction' && intl.formatMessage(messages.dismissSuggestion)}
                onActionClick={suggestion.source === 'past_interaction' && dismissSuggestion}
              />
            ))}
          </div>
        </div>
